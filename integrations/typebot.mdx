...
5. Insert the **Start Chat URL** _(_[_see section 2_](#2-obtaining-your-chatflow’s-start-chat-url)_)_
6. Under **Authorization**, add the **API Key** _(_[_see section 1_](#1-getting-your-api-key-from-typebot)_)_
...
2. For the device you want to link, click the **Integration dropdown** _(see screenshot below)_
   ...
   <img
     ...
     style={{ width:"40%" }}
   />
3. Select the **Typebot integration** you set up _(_[_see section 3_](#3-setting-up-the-typebot-integration)_)_
4. Done!
